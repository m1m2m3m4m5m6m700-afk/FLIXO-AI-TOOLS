...
`RPR-PROMPT-02-ERROR-INTELLIGENCE-001` is the canonical active repair-intelligence prompt. It consolidates the former master/task/specialist repair prompts at the prompt-selection layer. Specialist prompts are subordinate execution instructions and MUST NOT create a competing policy, control plane, registry, or certification authority.
