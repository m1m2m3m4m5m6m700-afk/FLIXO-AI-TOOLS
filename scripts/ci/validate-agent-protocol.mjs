...
const requiredFiles = ['AGENTS.md', 'docs/AGENT-COLLABORATION-PROTOCOL.md', 'scripts/ci/agent-session.mjs'];
...
if (ci && !/npm run validate:agent-protocol/u.test(ci)) failures.push('CI_NOT_WIRED=validate:agent-protocol');
