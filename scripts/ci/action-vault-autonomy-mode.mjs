...
if(read.monitoring?.allowedGapMs!==8*60*1000)errors.push('wakeAllowedGap');
...
if(!fs.readFileSync(path.resolve(ROOT,'.github/workflows/execution-bot-watchdog.yml'),'utf8').includes("- cron: '*/5 * * * *'"))errors.push('watchdog_five_minute_wake_missing');
