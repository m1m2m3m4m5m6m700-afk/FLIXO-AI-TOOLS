...
assert.match(source, /budgetIsSessionScoped: true/);
assert.match(source, /onBudgetExhausted: 'RECOVER_AND_REDISPATCH'/);
assert.match(source, /taskRemainsOpen: true/);
assert.match(source, /closureAllowedOnlyWhenCanonicalGreen: true/);
assert.match(source, /PERSIST_CONTINUATION_AND_REDISPATCH/);
assert.match(source, /stopConditions: \['CANONICAL_GREEN'\]/);
