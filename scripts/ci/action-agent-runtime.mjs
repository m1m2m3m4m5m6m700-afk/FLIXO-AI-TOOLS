...
const runtime={
  ...
  outputContract:{
    required:[ 'currentEvidence','unknowns','historicalMatches','candidateHypotheses','codeMentorPacket','selectedStrategy','selfCritique','independentReview','targetedRegression','exactSha','canonicalGreen' ],
