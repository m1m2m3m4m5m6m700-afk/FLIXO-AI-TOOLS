...
assert.ok(report.repairBrainMirror);
assert.equal(report.repairBrainMirror.mutationAuthority,false);
assert.equal(report.repairBrainMirror.certificationAuthority,false);
assert.equal(report.repairBrainMirror.tenXAnalyticProfile.route,'REPORT_ONLY');
assert.equal(report.repairBrainMirror.tenXAnalyticProfile.mutationReady,false);
