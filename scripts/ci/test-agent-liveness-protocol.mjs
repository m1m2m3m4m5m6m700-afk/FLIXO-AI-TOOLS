...
assert.doesNotMatch(heartbeatWorkflow,/schedule:/u);
...
assert.match(watchdogWorkflow,/Resident FLIXO10 one-minute pulse engine/u);
assert.match(watchdogWorkflow,/Re-arm resident watchdog on execution/u);
