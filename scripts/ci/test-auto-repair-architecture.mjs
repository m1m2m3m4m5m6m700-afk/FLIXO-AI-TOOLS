...
assert.doesNotMatch(heartbeat, /gh\s+workflow\s+run\s+daily-flixo-green-gate\.yml/);
assert.match(heartbeat, /CANONICAL_GREEN_GATE_WAKE_DEFERRED_TO_SCHEDULE_OR_CANONICAL_WORKFLOW_RUN/);
