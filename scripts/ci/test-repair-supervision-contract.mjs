...
assert.match(heartbeatWorkflow, /STALE_RUN_CANCELLATION=FAIL_CLOSED/);
assert.doesNotMatch(heartbeatWorkflow, /gh run cancel .*\|\| true/);
...
assert.match(heartbeatWorkflow, /actions: read/);
assert.doesNotMatch(heartbeatWorkflow, /actions: write/);
