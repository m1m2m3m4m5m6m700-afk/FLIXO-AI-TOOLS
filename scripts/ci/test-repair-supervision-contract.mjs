...
assert.match(heartbeatWorkflow, /actions\/workflows\/agent-repair-supervisor\.yml\/dispatches/);
assert.doesNotMatch(heartbeatWorkflow, /actions\/workflows\/daily-flixo-green-gate\.yml\/dispatches/);
assert.match(heartbeatWorkflow, /GREEN_GATE_WAKE_DEFERRED_TO_CANONICAL_SCHEDULE=true/);
