...
assert.match(heartbeatWorkflow, /group: \$\{\{ github\.event_name == 'workflow_dispatch' && github\.ref_name == 'execution' && 'flixo-agent-repair-resident' \|\| 'flixo-agent-repair-bootstrap' \}\}/);
