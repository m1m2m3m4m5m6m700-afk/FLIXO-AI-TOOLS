...
export function persistKnowledge(record){
 ...
 try{ execFileSync(process.execPath,[path.resolve(ROOT,'scripts/ci/sync-cognitive-learning-mesh.mjs')],{cwd:ROOT,stdio:'ignore',env:{...process.env,FLIXO_TARGET_SHA:record.targetSha??''}}); }catch(error){ console.warn('COGNITIVE_MESH_SYNC_WARNING='+String(error?.message??error)); }
