...
for(const id of ['ACTION-REPAIR','ACTION-REPAIR-2','ACTION-HISTORIAN-3','assistantController','MASTER-1','MASTER-2','MASTER-3','executionAgent','reviewAgent','SECURITY-REDTEAM-3']) if(!expectedBots.includes(id)) failures.push('GLOBAL_AUDIENCE_MISSING='+id);
