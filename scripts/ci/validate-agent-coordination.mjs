...
const expected = {
  ...
  'scripts/ci/agent-communication.mjs': ['validateMessage', 'ingest', 'createMessage', 'sendMessage', 'respondToMessage', 'listPendingResponses', 'markRead', 'markConsumed', 'MESSAGE_TYPES', 'REQUEST', 'RESPONSE', 'CHALLENGE', 'HANDOFF', 'AGENT_MESSAGE_IDEMPOTENCY_COLLISION', 'AGENT_MESSAGE_STALE_REQUIRES_REVALIDATION', 'AGENT_MESSAGE_RESPONSE_REQUIRES_READ', 'AGENT_MESSAGE_RESPONSE_SHA_STALE'],
