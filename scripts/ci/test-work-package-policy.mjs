...
assert.match(s,/ONE_WORK_PACKAGE_PER_REPAIR_BURST/); assert.match(s,/WORK_PACKAGE_BURST_REQUIRES_EXACTLY_ONE_WP_TAG/); assert.match(s,/WP-/); assert.match(s,/burstWorkPackages/); assert.match(s,/workPackageIds/);
