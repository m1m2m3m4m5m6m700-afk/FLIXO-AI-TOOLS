...
const allIntelligenceTestsPass=requiredPass&&benchmarkReport.allCasesPass===true;
...
const globalChecks={
 ...
 noSkippedTests:requiredPass,noContinueOnError:requiredPass,noWeakenedGate:requiredPass,noFalsePositive:requiredPass,noFalseGreen:watch.status==='GREEN',
