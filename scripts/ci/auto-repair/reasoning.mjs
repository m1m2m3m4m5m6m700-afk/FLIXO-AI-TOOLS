...
const PROFILES = Object.freeze([
  ...
  { id: 'webkit-render', feature: 'webkit', specificity: 0.96, dominates: ['playwright'], patterns: [/(?:\\bwebkit\\b|waitForGpuRender|data-render-revision)[^\\r\\n]{0,220}(?:failed|failure|error|timeout|mismatch|missing|did not advance)/i, /(?:failed|failure|error|timeout|mismatch|missing|did not advance)[^\\r\\n]{0,220}(?:\\bwebkit\\b|waitForGpuRender|data-render-revision)/i, /DEEP_SEMANTIC_MISSING=webkit(?::|\\b)/i, /GPU rendering[^\\r\\n]{0,220}(?:failed|failure|error|timeout|mismatch|missing)/i] },
