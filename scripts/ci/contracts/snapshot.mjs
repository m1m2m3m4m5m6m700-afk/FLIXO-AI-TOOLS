...
const contracts = [...CI_CONTRACTS].sort((a, b) => a.id.localeCompare(b.id)).map(canonicalize);
const snapshot = { schemaVersion: 1, contracts, contractIds: contracts.map((contract) => contract.id) };
