...
assert(registry.innovationPolicy?.permittedProposals?.includes('AGENT'));
assert(registry.innovationPolicy?.safeguards?.includes('NO_AUTOMATIC_MUTATION_AUTHORITY'));
assert(registry.innovationPolicy?.safeguards?.includes('NO_AUTOMATIC_CERTIFICATION_AUTHORITY'));
assert(registry.innovationPolicy?.safeguards?.includes('NO_SECOND_SOURCE_OF_TRUTH'));
