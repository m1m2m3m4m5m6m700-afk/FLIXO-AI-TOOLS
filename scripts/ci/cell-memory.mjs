...
export function learnIntoBotMemory({botId,taskId,taskShortName,taskName,knowledge,verification,evidenceRef,outcome,rootCause,rule,solution,weakness,upgrade,fingerprint,runId,targetSha,failedSha,normalizedFailure}={}){
