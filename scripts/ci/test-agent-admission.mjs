...
const actionVaultSession = {
  ...
  actionVaultMission: {
    ...
    sandboxProof: { protocol: 'REPAIR-SIMULATION-PROOF-v1', targetSha: targetSHA, failureFingerprint: 'fp-test', exactShaBound: true, mutationPerformed: false, status: 'PASS', ok: true, patchDigest: 'a'.repeat(64), regressionCounterexamples: { exhausted: true, counterexampleFound: false } },
