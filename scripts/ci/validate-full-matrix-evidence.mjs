...
const expectedSuites = [...new Set(planShardUnits.values().flatMap((unit) => unit.tests))].sort();
if (JSON.stringify(expectedSuites) !== JSON.stringify([...plan.suites].sort())) throw new Error('Matrix plan suite coverage is incomplete or duplicated.');
