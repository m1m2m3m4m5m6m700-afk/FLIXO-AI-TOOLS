...
export const COUNCIL_DIRECTIVE = Object.freeze({
  ...
  forbidden: Object.freeze(['fake-green','retry-until-green','test-weakening','symptom-only-repair','stale-evidence-as-proof','third-branch','force-reset-main','parallel-task-registry','llm-direct-execution']),
...
export function assertCouncilDirective(directive = COUNCIL_DIRECTIVE) {
  ...
  if (directive.llmDirectExecution !== false || directive.thirdBranchAllowed !== false) throw new Error('COUNCIL_DIRECTIVE_EXECUTION_BOUNDARY_INVALID');
