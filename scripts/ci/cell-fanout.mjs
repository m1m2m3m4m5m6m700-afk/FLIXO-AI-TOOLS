...
if(tasks.length===0||tasks.length>200) throw new Error('CELL_FANOUT_TASK_COUNT_MUST_BE_1_TO_200');
...
const batch={schemaVersion:1,batchId:'CELL-BATCH-'+crypto.randomUUID(),planId:plan.planId,planVersion:plan.planVersion,entrySha:plan.entrySha,parallel:true,maxConcurrent:200,assignments};
