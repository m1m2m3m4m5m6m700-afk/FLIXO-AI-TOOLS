...
if (find('full-matrix-parallel.yml')) {
  failures.push('Duplicate full-matrix-parallel.yml workflow must be removed; browser matrix ownership belongs to canonical ci.yml.');
}
