...
assert.equal(wakeResult.dispatchRequired,true);
assert.equal(wakeResult.dispatchWorkflow,'agent-repair-supervisor.yml');
assert.equal(wakeResult.canonicalNextStep,'AGENT_REPAIR_SUPERVISOR');
