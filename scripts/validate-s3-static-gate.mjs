...
const exactAllow = new Set([
  '.github/workflows/ci.yml', '.github/workflows/full-matrix-promotion.yml', '.github/workflows/root-cause-diagnostics.yml', '.github/workflows/s4-runtime-e2e.yml', '.github/workflows/localization-20.yml', '.github/workflows/parallel-diagnostics.yml', '.github/workflows/localization-core.yml', '.github/workflows/phase3-chain-e2e.yml', '.github/workflows/seo-production-certification.yml',
  'eslint.config.js', 'playwright.config.ts', 'scripts/ci/architecture-benchmark.mjs', 'scripts/ci/change-risk-planner.mjs', 'scripts/ci/evidence-ledger.mjs', 'scripts/ci/weighted-shard-plan.mjs', 'scripts/ci/write-build-artifact-manifest.mjs', 'scripts/ci/write-evidence-ledger.mjs',
