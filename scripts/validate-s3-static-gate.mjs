...
try {
  ...
  const exactAllow = new Set([
    ...
    'eslint.config.js', 'playwright.config.ts', 'scripts/validate-s3-static-gate.mjs', 'scripts/validate-s4-e2e.mjs', 'scripts/validate-site-origin.mjs', 'scripts/test-route-resolver.mjs', 'scripts/test-i18n-contract.mjs', 'scripts/test-seo-contract.mjs', 'scripts/test-upload-boundary.mjs', 'scripts/test-file-safety.mjs',
