...
const exactAllow = new Set([
  ...
  'src/tools/image-toolkit/index.tsx', 'src/tools/image-compressor/index.tsx', 'src/tools/image-compressor/output-contract.ts', 'src/tools/image-compressor/compressor.worker.ts', 'src/tools/image-compressor/engine.ts', 'src/tools/image-compressor/file-safety.ts', 'tests/image-converter.contract.spec.ts', 'tests/localization-runtime.spec.ts', 'tests/localization-all-routes.spec.ts', 'tests/g1-unready-routes.spec.ts', 'tests/runtime-certification.spec.ts', 'public/favicon.svg', 'public/flixo-logo.svg', 'public/flixo-logo.jpg', 'public/logo.svg', 'public/logo.jpg', 'index.html', '.env.example', '.gitleaks.toml',
