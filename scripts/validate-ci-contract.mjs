...
const required = [
  ...
  ['typecheck prerequisite', /needs:\s*\[typecheck,\s*lint,/],
  ['lint prerequisite', /needs:\s*\[typecheck,\s*lint,/],
  ['build prerequisite', /needs:\s*\[typecheck,\s*lint,\s*build,/],
  ['audit prerequisite', /needs:\s*\[typecheck,\s*lint,\s*build,\s*audit,/],
  ['socket prerequisite', /needs:\s*\[typecheck,\s*lint,\s*build,\s*audit,\s*socket,/],
  ['secret-scan prerequisite', /needs:\s*\[typecheck,\s*lint,\s*build,\s*audit,\s*socket,\s*secret-scan,/],
