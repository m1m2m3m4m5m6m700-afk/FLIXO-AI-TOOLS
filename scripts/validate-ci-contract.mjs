...
const watchdogExactVerify =
  ...
  /name: Verify exact watchdog checkout[\s\S]*ACTUAL_WATCHDOG_SHA="\$\(git rev-parse HEAD\)"[\s\S]*WATCHDOG_CHECKOUT_MODE=CANONICAL_EXECUTION_REF/.test(executionWatchdogWorkflow);
