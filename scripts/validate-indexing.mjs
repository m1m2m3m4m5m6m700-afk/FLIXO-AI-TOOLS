...
const siteOriginExpression = i18nSource.match(/export const SITE_ORIGIN = \(configuredSiteOrigin \|\| ([^)]+)\)/)?.[1]?.replace(/['`]/gu, '').trim();
if (siteOriginExpression !== 'https://flexoai.vercel.app') {
