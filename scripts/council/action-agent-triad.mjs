#!/usr/bin/env node
export const ACTION_AGENT_TRIAD_VERSION=1;
export const ACTION_AGENT_ACCOUNTS=Object.freeze(['CHIEF','WORKER_A','WORKER_B']);
export const ACTION_AGENT_PROFILES=Object.freeze({
 CHIEF:Object.freeze({accountId:'CHIEF',profileId:'ACTION_COMMANDER_V1',role:'ACTION_COMMANDER',mutationMode:'NONE',certificationAuthority:false,canDispatchTo:Object.freeze(['WORKER_A','WORKER_B']),fallbackAccountId:'CHIEF',requiredOutput:Object.freeze(['finding','evidence','evidenceGrade','unknowns','lesson','antiLesson','skillCandidate','directBenefit','nextAction','decisionTrace'])}),
 WORKER_A:Object.freeze({accountId:'WORKER_A',profileId:'ACTION_PRIMARY_REPAIR_V1',role:'PRIMARY_ACTION_REPAIR',mutationMode:'DELEGATED_REPAIR_ONLY',certificationAuthority:false,canDispatchTo:Object.freeze([]),fallbackAccountId:'WORKER_B',requiredOutput:Object.freeze(['finding','evidence','evidenceGrade','unknowns','lesson','antiLesson','skillCandidate','directBenefit','nextAction','decisionTrace'])}),
 WORKER_B:Object.freeze({accountId:'WORKER_B',profileId:'ACTION_ADVERSARIAL_REPAIR_V1',role:'ADVERSARIAL_ACTION_REPAIR',mutationMode:'DELEGATED_REPAIR_ONLY',certificationAuthority:false,canDispatchTo:Object.freeze([]),fallbackAccountId:'WORKER_A',requiredOutput:Object.freeze(['finding','evidence','evidenceGrade','unknowns','lesson','antiLesson','skillCandidate','directBenefit','nextAction','decisionTrace','challenge'])}),
});
