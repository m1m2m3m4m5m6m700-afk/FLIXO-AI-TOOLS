...
export const ACTION_AGENT_PROFILES=Object.freeze({
 ...
 WORKER_B:Object.freeze({accountId:'WORKER_B',profileId:'ACTION_ADVERSARIAL_REPAIR_V1',role:'ADVERSARIAL_ACTION_REPAIR',cognitionTier:COGNITION_TIERS.ADVERSARIAL,modelProfile:'FRONTIER_REASONING_ADVERSARIAL',reasoningEffort:'HIGH',reasoningModes:Object.freeze(['RCA','FALSIFICATION','ADVERSARIAL_REVIEW','SELF_CRITIQUE','VERIFICATION']),mutationMode:'DELEGATED_REPAIR_ONLY',certificationAuthority:false,canDispatchTo:Object.freeze([]),fallbackAccountId:'WORKER_A',requiredOutput:Object.freeze(['finding','evidence','evidenceGrade','unknowns','lesson','antiLesson','skillCandidate','directBenefit','nextAction','decisionTrace','challenge'])}),
});
