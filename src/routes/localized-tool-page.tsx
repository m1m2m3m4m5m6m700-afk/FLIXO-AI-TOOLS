  ...
  return (
    <main lang={seo.languageTag} dir={direction} className="tool-page-modern">
      ...
      <div className="tool-page-modern__body">
        ...
        <section className="tool-page-modern__workspace" aria-label={localizedTitle} aria-busy="false"><div className="tool-page-modern__workspace-bar"><span className="tool-page-modern__status"><span className="tool-page-modern__status-led" /> {copy.workspace}</span><span>{seo.tool.id}</span></div><div className="tool-page-modern__tool-host" data-flixo-i18n-root="tool-surface" aria-live="polite"><AutoLocalizedToolSurface locale={locale} toolId={seo.tool.id}><Suspense fallback={<div className="tool-page-modern__loading" role="status" aria-live="polite">{copy.loading}</div>}><ToolSurfaceSemanticBoundary><ToolComponent locale={locale} /></ToolSurfaceSemanticBoundary></Suspense></AutoLocalizedToolSurface></div></section>
