  ...
  return (
    <main data-tool-id={seo.tool.id} lang={seo.languageTag} dir={direction} className="tool-page-modern">
      ...
      <div className="tool-page-modern__body">
        <Suspense fallback={<div className="tool-page-modern__loading" role="status" aria-live="polite">{copy.loading}</div>}><LazyToolChainPanel currentToolId={seo.tool.id} locale={locale} /></Suspense>
