...
export function HomePage({ locale = 'en' as Locale }: { locale?: Locale }) {
  ...
  return (
    <main className="home-shell" lang={localeMetadata.languageTag} dir={localeMetadata.direction}>
      {paletteOpen && <Suspense fallback={null}><SmartCommandPalette onClose={() => setPaletteOpen(false)} /></Suspense>}
      ...
      <div className="home-container home-content">
        ...
        <Suspense fallback={<section className="flixo-ai-agent" aria-hidden="true" />}><FlixoAIAgent locale={locale} /></Suspense>
