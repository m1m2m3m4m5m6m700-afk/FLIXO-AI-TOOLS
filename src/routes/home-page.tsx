...
const LANGUAGE_LABELS: Record<string, string> = {
  en: 'English', ar: 'العربية', es: 'Español', fr: 'Français', de: 'Deutsch', ru: 'Русский', zh: '中文', hi: 'हिन्दी', id: 'Bahasa Indonesia', ur: 'اردو', ja: '日本語', ko: '한국어', nl: 'Nederlands', pl: 'Polski', pt: 'Português', it: 'Italiano', tr: 'Türkçe', vi: 'Tiếng Việt', th: 'ไทย', sv: 'Svenska',
};
