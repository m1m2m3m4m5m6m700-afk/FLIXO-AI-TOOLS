      ...
      <div className="space-y-6 p-6">
        ...
        <div className="border-t border-white/10 pt-4">
          ...
          {showAdvanced ? (
            <div
              id={detailsId}
              className="mt-4 space-y-3 rounded-xl border border-white/5 bg-black/30 p-4"
            >
              <div className="grid grid-cols-1 gap-4 text-xs text-neutral-300 md:grid-cols-2">
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <input
                    type="number"
                    defaultValue={1024}
                    className="rounded border border-white/10 bg-neutral-800/80 px-3 py-1.5 text-white outline-none focus:border-emerald-500"
                  />
                </label>
              </div>
            </div>
