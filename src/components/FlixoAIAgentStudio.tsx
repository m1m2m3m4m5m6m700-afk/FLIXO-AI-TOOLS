...
const AGENT_UI_COPY: Readonly<Record<Locale, AgentUiCopy>> = {
  ...
  es: { agentName: 'Agente FLIXO', navigation: 'Navegación del agente FLIXO', chat: 'Chat', history: 'Historial', projects: 'Proyectos', admin: 'Administración', changeLanguage: 'Cambiar idioma', tools: 'Herramientas de FLIXO', browseTools: 'Explorar herramientas', searchTools: 'Buscar herramientas…', all: 'Todo', images: 'Imágenes', video: 'Vídeo', filters: 'Filtros', you: 'Tú', openPreview: 'Abrir vista previa' },
  ...
  id: { agentName: 'Agen FLIXO', navigation: 'Navigasi agen FLIXO', chat: 'Obrolan', history: 'Riwayat', projects: 'Proyek', admin: 'Admin', changeLanguage: 'Ganti bahasa', tools: 'Alat FLIXO', browseTools: 'Jelajahi alat', searchTools: 'Cari alat…', all: 'Semua', images: 'Gambar', video: 'Video', filters: 'Filter', you: 'ANDA', openPreview: 'Buka pratinjau' },
  ...
  nl: { agentName: 'FLIXO-agent', navigation: 'FLIXO-agentnavigatie', chat: 'Chat', history: 'Geschiedenis', projects: 'Projecten', admin: 'Beheer', changeLanguage: 'Taal wijzigen', tools: 'FLIXO-tools', browseTools: 'Tools bekijken', searchTools: 'Tools zoeken…', all: 'Alle', images: 'Afbeeldingen', video: 'Video', filters: 'Filters', you: 'JIJ', openPreview: 'Voorbeeld openen' },
  ...
  pt: { agentName: 'Agente FLIXO', navigation: 'Navegação do agente FLIXO', chat: 'Chat', history: 'Histórico', projects: 'Projetos', admin: 'Administração', changeLanguage: 'Alterar idioma', tools: 'Ferramentas FLIXO', browseTools: 'Explorar ferramentas', searchTools: 'Pesquisar ferramentas…', all: 'Todos', images: 'Imagens', video: 'Vídeo', filters: 'Filtros', you: 'VOCÊ', openPreview: 'Abrir pré-visualização' },
