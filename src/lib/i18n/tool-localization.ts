...
const TERMS: Record<string, LocalizedTerms> = {
  ...
  trimmer: { ar: 'مُشذِّب', es: 'Recortador', fr: 'Découpeur', de: 'Trimmer', ru: 'Триммер', zh: '修剪器', hi: 'ट्रिमर', id: 'Pemangkas', ur: 'ٹرمر', ja: 'トリマー', pt: 'Cortador', it: 'Ritagliatore', ko: '트리머', nl: 'Trimmer', pl: 'Trymer', tr: 'Kırpıcı', vi: 'Trình cắt', th: 'ตัวตัด', sv: 'Trimverktyg' },
