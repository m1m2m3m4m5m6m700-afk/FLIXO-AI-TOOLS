...
export const CATEGORY_LABELS: Record<KnownLocale, Record<'Images' | 'AI' | 'Other', string>> = {
  ...
  zh: { Images: '图片', AI: '人工智能', Other: '其他' }, ur: { Images: 'تصاویر', AI: 'اے آئی', Other: 'دیگر' },
};
...
const TERMS: Record<string, LocalizedTerms> = {
  ...
  remover: { ar: 'إزالة', es: 'Eliminador', fr: 'Suppression', de: 'Entfernen', ru: 'Удаление', zh: '移除器', hi: 'हटाने वाला', id: 'Penghapus', ur: 'ہٹانے والا', ja: '削除', pt: 'Removedor', it: 'Rimozione', ko: '제거기', nl: 'Verwijderaar', pl: 'Usuwanie', tr: 'Kaldırıcı', vi: 'Công cụ xóa', th: 'ตัวลบ', sv: 'Borttagning', ms: 'Penyingkir', uk: 'Засіб видалення' },
  ...
  text: { ar: 'النص', es: 'Texto', fr: 'Texte', de: 'Text', ru: 'Текст', zh: '文本', ur: 'متن', hi: 'टेक्स्ट', id: 'Teks', ja: 'テキスト', pt: 'Texto', it: 'Testo', ko: '텍스트', nl: 'Tekst', pl: 'Tekst', tr: 'Metin', vi: 'Văn bản', th: 'ข้อความ', sv: 'Text', ms: 'Teks', uk: 'Текст' },
  audio: { ar: 'الصوت', es: 'Audio', fr: 'Audio', de: 'Audio', ru: 'Аудио', zh: '音频', ur: 'آڈیو', hi: 'ऑडियो', id: 'Audio', ja: '音声', pt: 'Áudio', it: 'Audio', ko: '오디오', nl: 'Audio', pl: 'Audio', tr: 'Ses', vi: 'Âm thanh', th: 'เสียง', sv: 'Ljud', ms: 'Audio', uk: 'Аудіо' },
  video: { ar: 'الفيديو', es: 'Vídeo', fr: 'Vidéo', de: 'Video', ru: 'Видео', zh: '视频', ur: 'ویڈیو', hi: 'वीडियो', id: 'Video', ja: '動画', pt: 'Vídeo', it: 'Video', ko: '비디오', nl: 'Video', pl: 'Wideo', tr: 'Video', vi: 'Video', th: 'วิดีโอ', sv: 'Video', ms: 'Video', uk: 'Відео' },
  ...
  pdf: { ar: 'PDF', en: 'PDF', es: 'PDF', fr: 'PDF', de: 'PDF', hi: 'PDF', id: 'PDF', it: 'PDF', ja: 'PDF', ko: 'PDF', ms: 'PDF', nl: 'PDF', pl: 'PDF', pt: 'PDF', ru: 'PDF', sv: 'PDF', th: 'PDF', tr: 'PDF', uk: 'PDF', vi: 'PDF', zh: 'PDF', ur: 'PDF' },
  svg: { ar: 'SVG', en: 'SVG', es: 'SVG', fr: 'SVG', de: 'SVG', hi: 'SVG', id: 'SVG', it: 'SVG', ja: 'SVG', ko: 'SVG', ms: 'SVG', nl: 'SVG', pl: 'SVG', pt: 'SVG', ru: 'SVG', sv: 'SVG', th: 'SVG', tr: 'SVG', uk: 'SVG', vi: 'SVG', zh: 'SVG', ur: 'SVG' },
  ocr: { ar: 'OCR', en: 'OCR', es: 'OCR', fr: 'OCR', de: 'OCR', hi: 'OCR', id: 'OCR', it: 'OCR', ja: 'OCR', ko: 'OCR', ms: 'OCR', nl: 'OCR', pl: 'OCR', pt: 'OCR', ru: 'OCR', sv: 'OCR', th: 'OCR', tr: 'OCR', uk: 'OCR', vi: 'OCR', zh: 'OCR', ur: 'OCR' },
  ai: { ar: 'الذكاء الاصطناعي', en: 'AI', es: 'IA', fr: 'IA', de: 'KI', hi: 'एआई', id: 'AI', it: 'IA', ja: 'AI', ko: 'AI', ms: 'AI', nl: 'AI', pl: 'AI', pt: 'IA', ru: 'ИИ', sv: 'AI', th: 'AI', tr: 'YZ', uk: 'ШІ', vi: 'AI', zh: '人工智能', ur: 'اے آئی' },
};
...
function fallbackTitle(locale: KnownLocale, category: 'Images' | 'AI' | 'Other'): string {
  const label = CATEGORY_LABELS[locale][category];
  const templates: Record<KnownLocale, string> = {
