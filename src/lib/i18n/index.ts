export { DEFAULT_LOCALE, LEGACY_LOCALES, LOCALES, LOCALE_METADATA, SITE_ORIGIN, X_DEFAULT_LOCALE, isLocale, normalizeLocale } from './config';
export type { Locale, CanonicalLocale, LegacyLocale, KnownLocale } from './config';
