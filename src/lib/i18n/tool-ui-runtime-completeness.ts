...
const FILTER_MASK_RUNTIME_COPY: Readonly<Record<string, Partial<Record<CanonicalLocale, string>>>> = {
  'Filter Mask live camera': { es: 'Cámara en directo de Filter Mask', it: 'Filter Mask · fotocamera live', ja: 'Filter Mask · ライブカメラ', th: 'กล้องสด Filter Mask', uk: 'Filter Mask · жива камера' },
  'Torch on': { it: 'Torcia attiva', uk: 'Ліхтарик увімкнено' },
  'Torch off': { es: 'Linterna desactivada', it: 'Torcia disattivata', ja: 'ライトオフ', th: 'ปิดไฟฉาย', uk: 'Ліхтарик вимкнено' },
  ...
  'Name this creator preset': { es: 'Nombra este preajuste de creador', it: 'Dai un nome a questo preset', ja: 'このクリエータープリセットに名前を付ける', th: 'ตั้งชื่อพรีเซ็ตครีเอเตอร์นี้', uk: 'Назвіть цей пресет' },
  'Capture quality': { es: 'Calidad de captura', it: 'Qualità di acquisizione', ja: 'キャプチャ品質', th: 'คุณภาพการจับภาพ', uk: 'Якість захоплення' },
  '720p standard': { es: '720p estándar', it: '720p standard', ja: '720p 標準', th: '720p มาตรฐาน', uk: '720p стандарт' },
  '1080p high': { es: '1080p alta', it: '1080p alta', ja: '1080p 高画質', th: '1080p สูง', uk: '1080p висока' },
  'Zoom': { es: 'Ampliación', it: 'Ingrandimento', ja: '拡大', th: 'การขยาย', uk: 'Масштаб' },
  'Mono': { es: 'Monocromo', it: 'Monocromatico', ja: 'モノクロ', th: 'ขาวดำ', uk: 'Монохромний' },
  'Color': { es: 'A color', ja: 'カラー', th: 'สี' },
  'Retro': { es: 'Estilo retro', ja: 'レトロ', th: 'สไตล์เรโทร' },
