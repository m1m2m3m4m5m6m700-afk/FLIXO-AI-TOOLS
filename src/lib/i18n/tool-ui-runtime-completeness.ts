...
const PREFIXES: ReadonlyArray<readonly [string, LocaleMap]> = [
  ...
  ['Output: ', { ar: 'الإخراج: ', es: 'Salida: ', fr: 'Sortie : ', de: 'Ausgabe: ', hi: 'आउटपुट: ', id: 'Keluaran: ', it: 'Output: ', ja: '出力: ', ko: '출력: ', ms: 'Keluaran: ', nl: 'Uitvoer: ', pl: 'Wyjście: ', pt: 'Saída: ', ru: 'Результat: ', sv: 'Utdata: ', th: 'เอาต์พุต: ', tr: 'Çıktı: ', uk: 'Вихід: ', vi: 'Đầu vào: ' }],
];
