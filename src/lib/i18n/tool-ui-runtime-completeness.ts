...
const UI: Readonly<Record<string, LocaleMap>> = {
  ...
  'Select PDF': { ar: 'اختر ملف PDF', es: 'Selecciona un PDF', fr: 'Sélectionnez un PDF', de: 'PDF auswählen', hi: 'PDF चुनें', id: 'Pilih PDF', it: 'Seleziona PDF', ja: 'PDFを選択', ko: 'PDF 선택', ms: 'Pilih PDF', nl: 'Selecteer PDF', pl: 'Wybierz PDF', pt: 'Selecione PDF', ru: 'Выберите файл PDF', sv: 'Välj PDF', th: 'เลือก PDF', tr: 'PDF seçin', uk: 'Виберіть PDF', vi: 'Chọn PDF' },
  ...
  'Compress image': { ar: 'ضغط الصورة', es: 'Comprimir imagen', fr: 'Compresser l’image', de: 'Bild komprimieren', hi: 'छवि संपीड़ित करें', id: 'Kompres gambar', it: 'Comprimi immagine', ja: '画像を圧縮', ko: '이미지를 압축', ms: 'Mampatkan imej', nl: 'Afbeelding comprimeren', pl: 'Kompresuj obraz', pt: 'Comprimir imagem', ru: 'Сжать изображение', sv: 'Komprimera bilden', th: 'บีบอัดรูปภาพ', tr: 'Görseli sıkıştır', uk: 'Стиснути зображення', vi: 'Nén hình ảnh' },
