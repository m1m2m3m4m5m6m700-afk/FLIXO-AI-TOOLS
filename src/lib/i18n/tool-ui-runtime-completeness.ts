...
const UI: Readonly<Record<string, LocaleMap>> = {
  ...
  'Compress all to ZIP': { ar: 'ضغط الكل إلى ZIP', es: 'Comprimir todo en ZIP', fr: 'Tout compresser en ZIP', de: 'Bild komprimieren', hi: 'सबको ZIP में संपीड़ित करें', id: 'Kompres semua ke ZIP', it: 'Comprimi tutto in ZIP', ja: 'すべてをZIPに圧縮', ko: '모두 ZIP으로 압축', ms: 'Mampatkan semua ke ZIP', nl: 'Alles naar ZIP comprimeren', pl: 'Skompresuj wszystko do ZIP', pt: 'Comprimir tudo em ZIP', ru: 'Сжать всё в ZIP', sv: 'Komprimera allt till ZIP', th: 'บีบอัดทั้งหมดเป็น ZIP', tr: 'Tümünü ZIP olarak sıkıştır', uk: 'Стиснути все в ZIP', vi: 'Nén tất cả thành ZIP' },
