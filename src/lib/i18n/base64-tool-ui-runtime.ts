...
const UI: Record<string, LocaleMap> = {
  ...
  Encode: { ar:'ترميز', es:'Codificar', fr:'Encoder', de:'Kodieren', hi:'एन्कोड', id:'Encode', it:'Codifica', ja:'エンコード', ko:'인코드', ms:'Enkod', nl:'Coderen', pl:'Koduj', pt:'Codificar', ru:'Кодировать', sv:'Koda', th:'เข้ารหัส', tr:'Kodla', uk:'Кодувати', vi:'Mã hóa' },
  ...
  Run: { ar:'تشغيل', es:'Ejecutar', fr:'Exécuter', de:'Ausführen', hi:'चलाएँ', id:'Jalankan', it:'Esegui', ja:'実行', ko:'실행', ms:'Jalankan', nl:'Uitvoeren', pl:'Uruchom', pt:'Executar', ru:'Запустить', sv:'Kör', th:'เรียกใช้', tr:'Çalıştır', uk:'Запustити', vi:'Chạy' },
