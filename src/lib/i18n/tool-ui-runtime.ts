...
function translateText(locale: Locale, value: string): string {
  ...
  if (toolChain) {
    ...
    const steps: Partial<Record<KnownLocale, string>> = { ar: 'خطوات', de: 'Schritte', es: 'pasos', fr: 'étapes', ru: 'шагов', zh: '步骤', hi: 'चरण', ja: 'ステップ', ko: '단계', pt: 'etapas', it: 'passaggi', nl: 'stappen', pl: 'kroków', tr: 'adım', vi: 'bước', th: 'ขั้นตอน', sv: 'steg', id: 'langkah', ur: 'مراحل' };
