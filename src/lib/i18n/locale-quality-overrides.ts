...
export const HOME_COPY_OVERRIDES: Readonly<Partial<Record<Locale, HomeCopyOverride>>> = Object.freeze({
  ...
  sv: Object.freeze({ browserMeta: 'Webbläsare först · Starta direkt', trust: Object.freeze([['Webbläsare först', 'Lokal bearbetning där verktyget stöder det.'], ['Snabb start', 'Direkta vägar utan onödig introduktion.'], ['Smart dirigering', 'Vanliga uppgifter går direkt till det bästa tillgängliga verktyget.']] as [string, string][]) }),
  ms: Object.freeze({
    language: 'ms', dir: 'ltr', nav: { tools: 'Alat', categories: 'Kategori', privacy: 'Privasi', switch: 'العربية' },
    badge: 'Privasi dahulu · Pelayar dahulu', eyebrow: 'FLIXO · KIT ALAT PINTAR', heroTitle: 'Alat yang tepat, [[tanpa jalan berliku.]]', heroLead: 'Cari tugasan, buka alat dan selesaikan dengan pantas. FLIXO mengekalkan pengalaman yang fokus dan menggunakan pemprosesan setempat dalam pelayar apabila disokong.',
  ...
  uk: Object.freeze({
    ...
    badge: 'Приватність передусім · Браузер передусім', eyebrow: 'FLIXO · РОЗУМНИЙ НАБІР ІНСТРУМЕНТІВ', heroTitle: 'Потрібний інструмент, [[без зайвих кроків.]]', heroLead: 'Знайдіть завдання, відкрийте інструмент і завершіть його швидко. FLIXO зберігає фокус і використовує локальну обробку в браузері, коли вона підтримується.',
