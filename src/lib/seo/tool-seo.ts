...
const LOCALE_LABELS: Record<Locale, string> = {
  ar: 'أداة عبر الإنترنت', en: 'Online tool', es: 'Herramienta en línea', fr: 'Outil en ligne', de: 'Online-Tool', hi: 'ऑनलाइन टूल', id: 'Alat online', it: 'Strumento online', ja: 'オンラインツール', ko: '온라인 도구', ms: 'Alat dalam talian', nl: 'Online tool', pl: 'Narzędzie online', pt: 'Ferramenta online', ru: 'Онлайн-инструмент', sv: 'Onlineverktyg', th: 'เครื่องมือออนไลน์', tr: 'Çevrimiçi araç', uk: 'Онлайн-інструмент', vi: 'Công cụ trực tuyến',
};
