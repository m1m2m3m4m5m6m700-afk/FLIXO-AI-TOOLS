...
const LOCALE_LABELS: Record<string, string> = {
  ar: 'أداة عبر الإنترنت', en: 'Online tool', es: 'Herramienta en línea', fr: 'Outil en ligne', de: 'Online-Tool', ru: 'Онлайн-инструмент', zh: '在线工具', hi: 'ऑनलाइन टूल', ur: 'آن لائن ٹول', id: 'Alat online', it: 'Strumento online', ja: 'オンラインツール', ko: '온라인 도구', nl: 'Online tool', pl: 'Narzędzie online', pt: 'Ferramenta online', sv: 'Onlineverktyg', th: 'เครื่องมือออนไลน์', tr: 'Çevrimiçi araç', vi: 'Công cụ trực tuyến', ms: 'Alat dalam talian', uk: 'Онлайн-інструмент',
};
...
const FALLBACK_COPY: Record<string, Readonly<{ open: string; configure: string; run: string; download: string; browser: string; interface: string }>> = {
  ...
  zh: { open: '打开工具。', configure: '调整可用选项。', run: '运行工具。', download: '下载结果。', browser: '浏览器本地处理', interface: '界面' },
  ...
  ur: { open: 'ٹول کھولیں۔', configure: 'دستیاب اختیارات ترتیب دیں۔', run: 'ٹول چلائیں۔', download: 'نتیجہ ڈاؤن لوڈ کریں۔', browser: 'براؤزر میں ترجیحی پروسیسنگ', interface: 'انٹرفیس' },
