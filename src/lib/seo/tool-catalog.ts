...
const CORE: Record<Locale, {
  ...
  ms: { online: 'Alat dalam talian', intro: 'Gunakan {title} FLIXO terus dalam pelayar anda dengan aliran kerja yang pantas dan mengutamakan privasi.', step1: 'Buka alat dan pilih input anda.', step2: 'Laraskan pilihan yang tersedia untuk mendapatkan hasil yang dikehendaki.', step3: 'Jalankan alat dan semak hasilnya dalam pelayar anda.', step4: 'Muat turun atau salin hasil yang siap.', features: ['Pemprosesan dalam pelayar', 'Tidak memerlukan akaun', 'Aliran kerja setempat yang pantas'], alt: 'Antara muka {title} dalam FLIXO' },
...
const TERM_MAPS: Record<Locale, Record<string, string>> = {
  ...
  ms: { Compressor: 'Pemampat', Converter: 'Penukar', Image: 'Imej', Video: 'Video', Audio: 'Audio', Text: 'Teks', AI: 'AI', Remover: 'Pembuang', Generator: 'Penjana' },
