...
const CORE: Record<Locale, {
  ...
  ms: { online: '在线工具', intro: '直接在浏览器中使用 FLIXO 的 {title}，体验快速且注重隐私的工作流程。', step1: '打开工具并选择输入内容。', step2: '调整可用选项以获得所需输出。', step3: '运行工具并在浏览器中查看结果。', step4: '下载或复制最终结果。', features: ['浏览器本地处理', '无需账号', '快速本地工作流'], alt: 'FLIXO 中的 {title} 界面' },
  ...
  uk: { online: 'آن لائن ٹول', intro: 'تیز اور پرائیویسی پر مبنی ورک فلو کے ساتھ FLIXO کا {title} براہِ راست براؤزر میں استعمال کریں۔', step1: 'ٹول کھولیں اور ان پٹ منتخب کریں۔', step2: 'مطلوبہ نتیجے کے لیے دستیاب اختیارات ترتیب دیں۔', step3: 'ٹول چلائیں اور نتیجہ دیکھیں۔', step4: 'حتمی نتیجہ ڈاؤن لوڈ یا کاپی کریں۔', features: ['براؤزر میں پراسیسنگ', 'اکاؤنٹ کی ضرورت نہیں', 'تیز مقامی ورک فلو'], alt: 'FLIXO میں {title} کا انٹرفیس' },
...
const TERM_MAPS: Record<Locale, Record<string, string>> = {
  ...
  ms: { Compressor: '压缩器', Converter: '转换器', Image: '图像', Video: '视频', Audio: '音频', Text: '文本', AI: '人工智能', Remover: '移除', Generator: '生成器' },
  ...
  uk: { Compressor: 'کمپریسر', Converter: 'کنورٹر', Image: 'تصاویر', Video: 'ویڈیو', Audio: 'آڈیو', Text: 'متن', AI: 'اے آئی', Remover: 'حذف', Generator: 'جنریٹر' },
