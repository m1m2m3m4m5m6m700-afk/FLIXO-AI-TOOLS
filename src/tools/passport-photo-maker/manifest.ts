...
export const PASSPORT_PHOTO_MAKER_MANIFEST: ToolManifest = Object.freeze({ toolId:'passport-photo-maker', slug:'passport-photo-maker', status:'ready', seoStatus:'complete', capabilities:['passport-photo','crop','resize','download'], seoLocales:Object.freeze({en, ar, es, fr, de, ru, hi, id, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk}) });
