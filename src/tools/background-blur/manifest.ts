...
import { pl } from './seo/pl'; import { tr } from './seo/tr'; import { vi } from './seo/vi'; import { th } from './seo/th'; import { sv } from './seo/sv'; import { ms } from './seo/ms'; import { uk } from './seo/uk';
...
export const BACKGROUND_BLUR_MANIFEST: ToolManifest = Object.freeze({
  ...
  seoLocales: Object.freeze({ en, ar, es, fr, de, ru, zh, hi, id, ur, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk }),
});
