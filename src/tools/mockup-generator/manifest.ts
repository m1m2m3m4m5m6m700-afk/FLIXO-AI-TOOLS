...
export const MOCKUP_GENERATOR_MANIFEST: ToolManifest = Object.freeze({ toolId:'mockup-generator', slug:'mockup-generator', status:'ready', seoStatus:'complete', capabilities:['client-side','mockup','image','download'], seoLocales:Object.freeze({en, ar, es, fr, de, ru, hi, id, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk}) });
