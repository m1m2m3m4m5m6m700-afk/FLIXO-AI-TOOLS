...
export const IMAGE_EFFECTS_MANIFEST: ToolManifest = Object.freeze({ toolId:'image-effects', slug:'image-effects', status:'ready', seoStatus:'complete', capabilities:['client-side','image-effects','web-worker','download'], seoLocales:Object.freeze({en, ar, es, fr, de, ru, hi, id, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk}) });
