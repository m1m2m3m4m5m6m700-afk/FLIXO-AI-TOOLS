...
export const IMAGE_TO_SVG_MANIFEST: ToolManifest = Object.freeze({ toolId:'image-to-svg', slug:'image-to-svg', status:'ready', seoStatus:'complete', capabilities:['client-side','image-to-svg','download'], seoLocales:Object.freeze({en, ar, es, fr, de, ru, hi, id, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk}) });
