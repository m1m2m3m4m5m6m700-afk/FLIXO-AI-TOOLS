...
export const CROP_RESIZE_MANIFEST: ToolManifest = Object.freeze({ toolId:'crop-resize', slug:'crop-resize', status:'ready', seoStatus:'complete', capabilities:['client-side','crop','resize','download'], seoLocales:Object.freeze({en, ar, es, fr, de, ru, hi, id, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk}) });
