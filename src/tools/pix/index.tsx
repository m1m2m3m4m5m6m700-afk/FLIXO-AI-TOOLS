...
export default function PixTool() {
  ...
  return <div className="mx-auto flex min-h-[650px] max-w-7xl flex-col gap-6 p-4 lg:flex-row" dir="rtl">
    ...
    {image && <aside className="w-full rounded-2xl border border-zinc-800 bg-zinc-900 p-6 lg:w-96">
      <div className="mb-5 flex items-center justify-between border-b border-zinc-800 pb-4"><div><p className="text-lg font-bold text-white">Pix Studio</p><p className="text-xs text-zinc-500">Liquify · Dispersion · Tune · Text · History · Export</p></div><label className="cursor-pointer rounded-lg bg-zinc-800 px-3 py-2 text-xs text-white">فتح صورة<input type="file" accept="image/*" className="hidden" onChange={handleImageUpload} /></label></div>
