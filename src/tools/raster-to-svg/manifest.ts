...
export const RASTER_TO_SVG_MANIFEST: ToolManifest = Object.freeze({ toolId:'raster-to-svg', slug:'raster-to-svg', status:'ready', seoStatus:'complete', capabilities:['client-side','raster-to-svg','svg','download'], seoLocales:Object.freeze({en, ar, es, fr, de, ru, hi, id, ja, pt, it, ko, nl, pl, tr, vi, th, sv, ms, uk}) });
