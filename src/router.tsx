...
import { enVideoCompressorConverterRoute } from './routes/video-compressor-converter';
import { enAiCaptionerSrtRoute } from './routes/ai-captioner-srt';
import { enAudioCutterTrimmerRoute } from './routes/audio-cutter-trimmer';
import { enAiVocalInstrumentalRemoverRoute } from './routes/ai-vocal-instrumental-remover';
import { enAudioCompressorRoute } from './routes/audio-compressor';
import { enAudioNoiseReducerRoute } from './routes/audio-noise-reducer';
import { enRegexTesterRoute } from './routes/regex-tools';
import { enHashGeneratorRoute } from './routes/hash-generator';
