...
export const TOOLS_REGISTRY: readonly ToolConfig[] = Object.freeze([
  ...
  { id: 'color-picker-palette', title: 'Color Picker & Palette Generator', path: '/en/color-picker-palette', description: 'Pick colors, generate palettes, and check WCAG contrast locally.', category: 'Other', isReady: true, component: lazy(() => import('@/tools/color-picker-palette').then((m) => ({ default: m.ColorPickerPaletteTool }))) },
