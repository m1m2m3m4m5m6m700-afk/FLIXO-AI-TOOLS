...
CURRENT MAIN SHA = 419c164404250386f2d14874481e46546b4520fc
```
...
The validator fails closed when emitted browser JavaScript contains server-side Admin secret/boundary markers including `ADMIN_SESSION_SECRET`, `/api/admin/`, `authorizeAdminRequest`, `createHmac`, or `signAdminSession`.

Regression history:
`34800176880` failed only because ESLint rejected an unnecessary escape in the new validator; the causal defect was repaired in `edc043f8223a0d7ee2aa138c94ec928a4ab90b0f`.

Required next proof:
Fresh canonical CI/certification on `main @ 419c164404250386f2d14874481e46546b4520fc` and no new independent root cause.
